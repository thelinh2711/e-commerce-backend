...
=====================================================
*/
INSERT INTO products (name, description, price, brand_id, sku, stock, total_product, slug, created_at) VALUES
-- Nike (1-10)
('Nike Air Zoom Pegasus 40', 'Giày chạy bộ huyền thoại, êm ái và ổn định.', 3200000, 1, 'NIKE-PEG40', 100, 150, 'nike-air-zoom-pegasus-40', '2025-09-15 10:00:00'),
('Nike Mercurial Superfly 9', 'Giày đá banh tốc độ, thiết kế cho sân cỏ tự nhiên.', 4500000, 1, 'NIKE-MERC9', 50, 80, 'nike-mercurial-superfly-9', '2025-09-20 14:30:00'),
('Áo Thun Nike Dri-FIT Miller', 'Áo thun chạy bộ, công nghệ Dri-FIT thoáng khí.', 850000, 1, 'NIKE-MILLER-T', 200, 300, 'ao-thun-nike-dri-fit-miller', '2025-10-01 09:15:00'),
('Quần Short Nike Challenger', 'Quần short chạy bộ 2 lớp, có túi đựng điện thoại.', 1100000, 1, 'NIKE-CHAL-SHORT', 150, 220, 'quan-short-nike-challenger', '2025-10-05 11:20:00'),
('Quần Legging Nike Pro', 'Quần legging tập luyện, co giãn và hỗ trợ cơ bắp.', 1300000, 1, 'NIKE-PRO-LEG', 100, 180, 'quan-legging-nike-pro', '2025-10-10 16:45:00'),
('Áo Khoác Nike Windrunner', 'Áo khoác gió, chống nước nhẹ, thiết kế cổ điển.', 2500000, 1, 'NIKE-WINDRUN', 80, 120, 'ao-khoac-nike-windrunner', '2025-10-12 13:30:00'),
('Áo Bra Nike Swoosh', 'Áo lót thể thao hỗ trợ vừa, thoải mái.', 900000, 1, 'NIKE-SWOOSH-BRA', 120, 200, 'ao-bra-nike-swoosh', '2025-10-15 10:00:00'),
('Tất Nike Everyday Plus', 'Tất thể thao, đệm êm, thấm hút mồ hôi (bộ 3 đôi).', 450000, 1, 'NIKE-SOCK-3P', 300, 500, 'tat-nike-everyday-plus', '2025-10-18 15:20:00'),
('Balo Nike Brasilia', 'Balo thể thao, dung tích lớn, nhiều ngăn.', 1200000, 1, 'NIKE-BRASILIA-BP', 100, 140, 'balo-nike-brasilia', '2025-10-20 12:00:00'),
('Bóng Rổ Nike Everyday', 'Bóng rổ size 7, chất liệu cao su bền bỉ.', 700000, 1, 'NIKE-BALL-BB', 60, 100, 'bong-ro-nike-everyday', '2025-10-22 14:15:00'),

-- Adidas (11-20)
('Adidas Ultraboost Light', 'Giày chạy bộ với đệm Boost nhẹ nhất từ trước đến nay.', 4800000, 2, 'ADI-UBLIGHT', 100, 160, 'adidas-ultraboost-light', '2025-09-18 11:00:00'),
('Adidas Predator Accuracy', 'Giày đá banh kiểm soát, upper công nghệ mới.', 5200000, 2, 'ADI-PRED-ACC', 50, 75, 'adidas-predator-accuracy', '2025-09-25 15:30:00'),
('Áo Thun Adidas Own The Run', 'Áo thun chạy bộ, chất liệu tái chế, thoáng mát.', 950000, 2, 'ADI-OTR-TEE', 200, 280, 'ao-thun-adidas-own-the-run', '2025-10-02 10:45:00'),
('Quần Short Adidas 3-Stripes', 'Quần short thể thao, phong cách 3 sọc cổ điển.', 750000, 2, 'ADI-3S-SHORT', 150, 230, 'quan-short-adidas-3-stripes', '2025-10-06 12:30:00'),
('Quần Dài Adidas Tiro 23', 'Quần dài thể thao, dáng ôm, khóa kéo ở cổ chân.', 1400000, 2, 'ADI-TIRO23', 100, 170, 'quan-dai-adidas-tiro-23', '2025-10-08 14:00:00'),
('Áo Khoác Nỉ Adidas Essentials', 'Áo khoác nỉ 3 sọc, giữ ấm tốt.', 1800000, 2, 'ADI-ESS-HOODIE', 80, 130, 'ao-khoac-ni-adidas-essentials', '2025-10-11 10:30:00'),
('Áo Bra Tập Luyện Adidas TLRD', 'Áo lót thể thao hỗ trợ cao, tùy chỉnh.', 1100000, 2, 'ADI-TLRD-BRA', 120, 190, 'ao-bra-tap-luyen-adidas-tlrd', '2025-10-14 09:00:00'),
('Mũ Adidas Baseball', 'Mũ lưỡi trai, logo thêu, quai điều chỉnh.', 550000, 2, 'ADI-CAP-BB', 300, 450, 'mu-adidas-baseball', '2025-10-17 15:45:00'),
('Túi Trống Adidas Defender', 'Túi trống tập gym, size M, chống nước.', 1300000, 2, 'ADI-DEF-DUFFEL', 100, 150, 'tui-trong-adidas-defender', '2025-10-19 11:15:00'),
('Bóng Đá Adidas Al Rihla', 'Bóng đá thi đấu chính thức World Cup 2022.', 3500000, 2, 'ADI-BALL-WC22', 60, 90, 'bong-da-adidas-al-rihla', '2025-10-21 16:20:00'),

-- Puma (21-30)
('Puma Velocity Nitro 2', 'Giày chạy bộ, đệm Nitro Foam êm ái.', 2800000, 3, 'PUMA-VELO-N2', 100, 140, 'puma-velocity-nitro-2', '2025-09-22 10:00:00'),
('Puma Future Ultimate', 'Giày đá banh linh hoạt, không dây.', 4300000, 3, 'PUMA-FUTURE-ULT', 50, 70, 'puma-future-ultimate', '2025-09-28 14:30:00'),
('Áo Thun Puma Essentials Logo', 'Áo thun cotton, logo Puma lớn trước ngực.', 600000, 3, 'PUMA-ESS-TEE', 200, 350, 'ao-thun-puma-essentials-logo', '2025-10-03 09:30:00'),
('Quần Short Puma Fit Woven', 'Quần short tập luyện, vải dệt nhẹ, co giãn.', 800000, 3, 'PUMA-FIT-SHORT', 150, 210, 'quan-short-puma-fit-woven', '2025-10-07 13:15:00'),
('Quần Jogger Puma T7', 'Quần jogger, viền T7 cổ điển 2 bên.', 1200000, 3, 'PUMA-T7-JOGGER', 100, 160, 'quan-jogger-puma-t7', '2025-10-09 11:45:00'),
('Áo Khoác Puma Iconic T7', 'Áo khoác thể thao, phong cách T7 cổ điển.', 1700000, 3, 'PUMA-T7-JACKET', 80, 125, 'ao-khoac-puma-iconic-t7', '2025-10-13 14:30:00'),
('Đồ Tập Gym Puma Fit', 'Bộ đồ tập gym nữ, chất liệu co giãn.', 1500000, 3, 'PUMA-FIT-SET', 120, 170, 'do-tap-gym-puma-fit', '2025-10-16 10:20:00'),
('Tất Puma Quarter (3 đôi)', 'Tất cổ ngắn, chất liệu cotton.', 300000, 3, 'PUMA-SOCK-3P', 300, 480, 'tat-puma-quarter-3-doi', '2025-10-19 16:00:00'),
('Balo Puma Phase', 'Balo đi học, đi làm, thiết kế đơn giản.', 700000, 3, 'PUMA-PHASE-BP', 100, 145, 'balo-puma-phase', '2025-10-22 12:45:00'),
('Thảm Tập Yoga Puma', 'Thảm tập yoga, chống trơn trượt.', 900000, 3, 'PUMA-YOGA-MAT', 60, 95, 'tham-tap-yoga-puma', '2025-10-24 15:30:00'),

-- Under Armour (31-40)
('UA HOVR Phantom 3', 'Giày chạy bộ thông minh, kết nối app.', 3800000, 4, 'UA-HOVR-PH3', 100, 155, 'ua-hovr-phantom-3', '2025-09-25 11:30:00'),
('Giày Đá Banh UA Clone Magnetico', 'Giày đá banh, upper ôm sát như lớp da thứ 2.', 4100000, 4, 'UA-CLONE-MAG', 50, 85, 'giay-da-banh-ua-clone-magnetico', '2025-09-30 15:00:00'),
('Áo Thun UA HeatGear', 'Áo thun nén cơ, giữ mát và khô ráo.', 900000, 4, 'UA-HG-TEE', 200, 290, 'ao-thun-ua-heatgear', '2025-10-04 10:00:00'),
('Quần Short UA Launch Run', 'Quần short chạy bộ, siêu nhẹ, có túi.', 1000000, 4, 'UA-LAUNCH-SHORT', 150, 225, 'quan-short-ua-launch-run', '2025-10-08 13:45:00'),
('Quần Legging UA RUSH', 'Quần legging, công nghệ RUSH hoàn trả năng lượng.', 1800000, 4, 'UA-RUSH-LEG', 100, 175, 'quan-legging-ua-rush', '2025-10-11 09:30:00'),
('Áo Khoác UA Storm', 'Áo khoác chống nước, chống gió, siêu nhẹ.', 2800000, 4, 'UA-STORM-JACKET', 80, 135, 'ao-khoac-ua-storm', '2025-10-14 14:15:00'),
('Áo Bra UA Infinity High', 'Áo lót thể thao hỗ trợ cao, đệm mút liền.', 1500000, 4, 'UA-INF-BRA', 120, 185, 'ao-bra-ua-infinity-high', '2025-10-17 11:00:00'),
('Mũ UA Iso-Chill', 'Mũ tập luyện, công nghệ làm mát Iso-Chill.', 750000, 4, 'UA-ISO-CAP', 300, 420, 'mu-ua-iso-chill', '2025-10-20 16:30:00'),
('Túi Trống UA Undeniable 5.0', 'Túi trống, công nghệ Storm chống nước.', 1400000, 4, 'UA-UNDENIABLE-5', 100, 160, 'tui-trong-ua-undeniable-5-0', '2025-10-23 12:20:00'),
('Găng Tay Tập Gym UA', 'Găng tay tập tạ, đệm êm, bám dính tốt.', 600000, 4, 'UA-GYM-GLOVE', 60, 105, 'gang-tay-tap-gym-ua', '2025-10-25 15:45:00'),

-- ASICS (41-50)
('ASICS GEL-Kayano 30', 'Giày chạy bộ ổn định, công nghệ GEL êm ái.', 4200000, 5, 'ASICS-KAYANO30', 100, 165, 'asics-gel-kayano-30', '2025-09-16 12:00:00'),
('ASICS GEL-Nimbus 25', 'Giày chạy bộ siêu êm, đệm dày.', 4000000, 5, 'ASICS-NIMBUS25', 50, 82, 'asics-gel-nimbus-25', '2025-09-21 15:30:00'),
('Áo Thun ASICS Ventilate', 'Áo thun chạy bộ, siêu thoáng khí.', 1000000, 5, 'ASICS-VENT-TEE', 200, 310, 'ao-thun-asics-ventilate', '2025-10-01 10:45:00'),
('Quần Short ASICS Road 2-in-1', 'Quần short chạy bộ 2 lớp, có túi gel.', 1200000, 5, 'ASICS-ROAD-SHORT', 150, 240, 'quan-short-asics-road-2-in-1', '2025-10-05 14:00:00'),
('Quần Legging ASICS Lite-Show', 'Quần legging chạy tối, phản quang 360 độ.', 1500000, 5, 'ASICS-LITE-LEG', 100, 165, 'quan-legging-asics-lite-show', '2025-10-10 12:30:00'),
('Áo Khoác ASICS Accelerate', 'Áo khoác chạy bộ, chống gió, chống mưa nhẹ.', 2200000, 5, 'ASICS-ACC-JACKET', 80, 128, 'ao-khoac-asics-accelerate', '2025-10-13 09:45:00'),
('Áo Bra ASICS Sakura', 'Áo lót thể thao, thiết kế hoa anh đào.', 950000, 5, 'ASICS-SKR-BRA', 120, 195, 'ao-bra-asics-sakura', '2025-10-16 11:20:00'),
('Tất Chạy Bộ ASICS (3 đôi)', 'Tất chạy bộ, mỏng nhẹ, chống phồng rộp.', 500000, 5, 'ASICS-RUN-SOCK', 300, 470, 'tat-chay-bo-asics-3-doi', '2025-10-19 14:50:00'),
('Balo Chạy Bộ ASICS', 'Balo/vest chạy bộ, đựng nước và gel.', 1800000, 5, 'ASICS-RUN-VEST', 100, 148, 'balo-chay-bo-asics', '2025-10-22 10:30:00'),
('Băng Đô ASICS', 'Băng đô thể thao, thấm hút mồ hôi.', 300000, 5, 'ASICS-HEADBAND', 60, 110, 'bang-do-asics', '2025-10-24 16:15:00'),

-- New Balance (51-60)
('New Balance Fresh Foam X 1080v13', 'Giày chạy bộ, đệm Fresh Foam X siêu êm.', 3900000, 6, 'NB-1080V13', 100, 158, 'nb-fresh-foam-x-1080v13', '2025-09-19 13:00:00'),
('New Balance 550', 'Giày thể thao thời trang, phong cách bóng rổ cổ điển.', 2800000, 6, 'NB-550', 50, 88, 'nb-550', '2025-09-24 16:00:00'),
('Áo Thun NB Essentials', 'Áo thun cotton, logo NB cổ điển.', 700000, 6, 'NB-ESS-TEE', 200, 330, 'ao-thun-nb-essentials', '2025-10-02 11:30:00'),
('Quần Short NB Accelerate', 'Quần short chạy bộ, chất liệu nhẹ, khô nhanh.', 850000, 6, 'NB-ACC-SHORT', 150, 235, 'quan-short-nb-accelerate', '2025-10-06 14:45:00'),
('Quần Jogger NB Athletics', 'Quần jogger nỉ, thời trang, thoải mái.', 1400000, 6, 'NB-ATH-JOGGER', 100, 172, 'quan-jogger-nb-athletics', '2025-10-09 10:15:00'),
('Áo Khoác Gió NB Impact Run', 'Áo khoác chạy bộ, siêu mỏng, gấp gọn được.', 2100000, 6, 'NB-IMP-JACKET', 80, 132, 'ao-khoac-gio-nb-impact-run', '2025-10-12 15:00:00'),
('Đồ Tập Gym NB Relentless', 'Bộ đồ tập gym nữ, thiết kế thời trang.', 1600000, 6, 'NB-RELENT-SET', 120, 188, 'do-tap-gym-nb-relentless', '2025-10-15 12:30:00'),
('Mũ NB Classic', 'Mũ lưỡi trai, logo NB.', 500000, 6, 'NB-CLASSIC-CAP', 300, 460, 'mu-nb-classic', '2025-10-18 09:45:00'),
('Túi Đeo Chéo NB', 'Túi đeo chéo nhỏ gọn, tiện lợi.', 650000, 6, 'NB-CROSSBODY', 100, 155, 'tui-deo-cheo-nb', '2025-10-21 14:20:00'),
('Giày NB 574', 'Giày thời trang, thiết kế 574 huyền thoại.', 2300000, 6, 'NB-574', 60, 102, 'giay-nb-574', '2025-10-23 16:00:00'),

-- Reebok (61-70)
('Reebok Nano X4', 'Giày tập gym, CrossFit, đế ổn định.', 3300000, 7, 'RBK-NANO-X4', 100, 162, 'reebok-nano-x4', '2025-09-17 10:30:00'),
('Reebok Classic Leather', 'Giày thời trang, da thật, phong cách cổ điển.', 2100000, 7, 'RBK-CLASSIC-L', 50, 86, 'reebok-classic-leather', '2025-09-23 14:00:00'),
('Áo Thun Reebok CrossFit', 'Áo thun chuyên dụng cho CrossFit.', 800000, 7, 'RBK-CF-TEE', 200, 315, 'ao-thun-reebok-crossfit', '2025-10-01 11:15:00'),
('Quần Short Reebok Speedwick', 'Quần short tập luyện, thấm hút mồ hôi.', 900000, 7, 'RBK-SPEED-SHORT', 150, 238, 'quan-short-reebok-speedwick', '2025-10-04 15:30:00'),
('Quần Legging Reebok Lux', 'Quần legging cao cấp, mềm mại, co giãn tốt.', 1300000, 7, 'RBK-LUX-LEG', 100, 168, 'quan-legging-reebok-lux', '2025-10-08 12:00:00'),
('Áo Hoodie Reebok Classic', 'Áo hoodie nỉ, logo vector lớn.', 1600000, 7, 'RBK-CLASSIC-HOOD', 80, 134, 'ao-hoodie-reebok-classic', '2025-10-11 14:45:00'),
('Áo Bra Reebok Lux High-Support', 'Áo lót thể thao hỗ trợ cao, cho CrossFit.', 1100000, 7, 'RBK-LUX-BRA', 120, 192, 'ao-bra-reebok-lux-high-support', '2025-10-14 10:30:00'),
('Tất Reebok Classic (3 đôi)', 'Tất cổ cao, logo Reebok.', 350000, 7, 'RBK-SOCK-3P', 300, 465, 'tat-reebok-classic-3-doi', '2025-10-17 16:15:00'),
('Balo Reebok Training', 'Balo tập luyện, ngăn đựng giày riêng.', 1100000, 7, 'RBK-TRAIN-BP', 100, 158, 'balo-reebok-training', '2025-10-20 13:00:00'),
('Dây Nhảy Reebok', 'Dây nhảy tốc độ, tay cầm bọc đệm.', 400000, 7, 'RBK-JUMP-ROPE', 60, 108, 'day-nhay-reebok', '2025-10-22 15:45:00'),

-- The North Face (71-80)
('Giày Leo Núi TNF VECTIV', 'Giày leo núi, công nghệ VECTIV trợ lực.', 4500000, 8, 'TNF-VECTIV-HIKE', 100, 154, 'giay-leo-nui-tnf-vectiv', '2025-09-20 12:30:00'),
('Áo Khoác TNF Resolve 2', 'Áo khoác chống nước, công nghệ DryVent 2L.', 2900000, 8, 'TNF-RESOLVE-2', 50, 84, 'ao-khoac-tnf-resolve-2', '2025-09-26 15:00:00'),
('Áo Thun TNF Simple Dome', 'Áo thun cotton, logo TNF nhỏ.', 750000, 8, 'TNF-DOME-TEE', 200, 320, 'ao-thun-tnf-simple-dome', '2025-10-02 09:45:00'),
('Quần Short TNF Movmynt', 'Quần short chạy trail, siêu nhẹ.', 1300000, 8, 'TNF-MOVMYNT-SHORT', 150, 232, 'quan-short-tnf-movmynt', '2025-10-05 13:30:00'),
('Quần Dài TNF Paramount', 'Quần dã ngoại, tháo ống thành quần short.', 2200000, 8, 'TNF-PARAMOUNT-PANT', 100, 166, 'quan-dai-tnf-paramount', '2025-10-09 11:00:00'),
('Áo Khoác Lông Vũ TNF Nuptse', 'Áo khoác lông vũ, giữ ấm, kiểu dáng retro.', 7500000, 8, 'TNF-NUPTSE-JCKT', 80, 126, 'ao-khoac-long-vu-tnf-nuptse', '2025-10-12 14:15:00'),
('Áo Nỉ TNF Glacier', 'Áo nỉ mỏng, giữ ấm, mặc lót.', 1500000, 8, 'TNF-GLACIER-FLC', 120, 186, 'ao-ni-tnf-glacier', '2025-10-15 10:45:00'),
('Mũ Nồi TNF', 'Mũ len giữ ấm, logo thêu.', 600000, 8, 'TNF-BEANIE', 300, 455, 'mu-noi-tnf', '2025-10-18 16:30:00'),
('Balo TNF Borealis', 'Balo đa năng, đi học, đi làm, đi phượt.', 2600000, 8, 'TNF-BOREALIS-BP', 100, 152, 'balo-tnf-borealis', '2025-10-21 12:15:00'),
('Găng Tay TNF Etip', 'Găng tay nỉ, cảm ứng điện thoại được.', 900000, 8, 'TNF-ETIP-GLOVE', 60, 104, 'gang-tay-tnf-etip', '2025-10-23 14:45:00'),

-- Columbia (81-90)
('Giày Lội Nước Columbia Drainmaker', 'Giày lội nước, đi biển, thoát nước nhanh.', 2400000, 9, 'COL-DRAINMAKER', 100, 156, 'giay-loi-nuoc-columbia-drainmaker', '2025-09-21 11:00:00'),
('Áo Khoác Columbia Watertight II', 'Áo khoác chống nước, công nghệ Omni-Tech.', 2300000, 9, 'COL-WATERTIGHT-2', 50, 83, 'ao-khoac-columbia-watertight-ii', '2025-09-27 14:30:00'),
('Áo Thun Columbia PFG', 'Áo thun câu cá, chống tia UV.', 900000, 9, 'COL-PFG-TEE', 200, 305, 'ao-thun-columbia-pfg', '2025-10-02 10:15:00'),
('Quần Short Columbia Silver Ridge', 'Quần short dã ngoại, vải mỏng nhẹ.', 1100000, 9, 'COL-SR-SHORT', 150, 228, 'quan-short-columbia-silver-ridge', '2025-10-05 13:45:00'),
('Quần Dài Columbia Omni-Heat', 'Quần giữ nhiệt, công nghệ phản nhiệt Omni-Heat.', 1900000, 9, 'COL-OH-PANT', 100, 164, 'quan-dai-columbia-omni-heat', '2025-10-09 11:30:00'),
('Áo Sơ Mi Columbia Bahama', 'Áo sơ mi dã ngoại, câu cá, nhanh khô.', 1300000, 9, 'COL-BAHAMA-SHIRT', 80, 131, 'ao-so-mi-columbia-bahama', '2025-10-12 14:45:00'),
('Áo Nỉ Columbia Steens Mountain', 'Áo nỉ dày, giữ ấm tốt.', 1200000, 9, 'COL-STEENS-FLC', 120, 183, 'ao-ni-columbia-steens-mountain', '2025-10-15 11:15:00'),
('Mũ Rộng Vành Columbia Bora Bora', 'Mũ dã ngoại, chống UV, thoáng khí.', 800000, 9, 'COL-BORA-HAT', 300, 448, 'mu-rong-vanh-columbia-bora-bora', '2025-10-18 15:00:00'),
('Balo Columbia Newton Ridge', 'Balo dã ngoại, dung tích 25L.', 1700000, 9, 'COL-NEWTON-BP', 100, 151, 'balo-columbia-newton-ridge', '2025-10-21 12:45:00'),
('Khăn Đa Năng Columbia', 'Khăn ống đa năng, chống nắng.', 400000, 9, 'COL-GAITER', 60, 106, 'khan-da-nang-columbia', '2025-10-23 15:30:00'),

-- Decathlon (Quechua/Kipsta/Domyos) (91-100)
('Giày Chạy Bộ Kiprun KD900X', 'Giày chạy bộ thi đấu, đệm carbon.', 3000000, 10, 'DEC-KD900X', 100, 159, 'giay-chay-bo-kiprun-kd900x', '2025-09-18 12:15:00'),
('Giày Đá Banh Kipsta Viralto IV', 'Giày đá banh da thật, giá tốt.', 1500000, 10, 'DEC-VIRALTO4', 50, 89, 'giay-da-banh-kipsta-viralto-iv', '2025-09-24 15:45:00'),
('Áo Thun Domyos Fit', 'Áo thun tập gym, giá rẻ, thoáng mát.', 150000, 10, 'DEC-DOMYOS-TEE', 200, 380, 'ao-thun-domyos-fit', '2025-10-01 09:00:00'),
('Quần Short Domyos 2-in-1', 'Quần short tập gym, có lớp lót.', 350000, 10, 'DEC-DOMYOS-SHORT', 150, 255, 'quan-short-domyos-2-in-1', '2025-10-04 12:30:00'),
('Quần Legging Domyos Nữ', 'Quần legging tập yoga, co giãn.', 250000, 10, 'DEC-DOMYOS-LEG', 100, 185, 'quan-legging-domyos-nu', '2025-10-07 10:45:00'),
('Áo Khoác Gió Quechua MH100', 'Áo khoác gió dã ngoại, chống nước nhẹ.', 400000, 10, 'DEC-QUE-MH100', 80, 145, 'ao-khoac-gio-quechua-mh100', '2025-10-10 14:15:00'),
('Áo Bra Domyos', 'Áo lót thể thao, hỗ trợ vừa.', 200000, 10, 'DEC-DOMYOS-BRA', 120, 210, 'ao-bra-domyos', '2025-10-13 11:30:00'),
('Tất Chạy Bộ Kiprun (2 đôi)', 'Tất chạy bộ, chống phồng rộp.', 180000, 10, 'DEC-KIPRUN-SOCK', 300, 520, 'tat-chay-bo-kiprun-2-doi', '2025-10-16 15:45:00'),
('Balo Quechua NH100 (20L)', 'Balo dã ngoại, đi học, giá rẻ.', 250000, 10, 'DEC-QUE-NH100', 100, 175, 'balo-quechua-nh100-20l', '2025-10-19 12:30:00'),
('Thảm Tập Yoga Domyos 8mm', 'Thảm tập yoga, dày 8mm, êm ái.', 500000, 10, 'DEC-YOGA-MAT8', 60, 115, 'tham-tap-yoga-domyos-8mm', '2025-10-22 16:00:00');
...
INSERT INTO cart_items (cart_id, product_id, product_variant_id, quantity, unit_price, total_price) VALUES
