...
-- order_vouchers (Áp dụng voucher cho một số đơn hàng)
...
-- product_variant_images (Ảnh cho các biến thể - VD: ảnh giày màu đen, màu trắng)
...
-- cart_items (Thêm sản phẩm vào giỏ hàng cho 5 user đầu)
...
-- wishlist_items (Thêm sản phẩm vào wishlist cho 5 user)
...
-- message_attachments (Đính kèm cho tin nhắn 9)
